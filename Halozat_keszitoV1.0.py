...
class HalozatGeneraloGrafikusFelulettel:
    ...
    def adatabetoltese_lap_inicializalas(self, notebook):
        ...
        # Adat betöltés gomb
        ttk.Button(adatlap_vaz, text="Publkiációs adatok betöltése", command=self.adatbetoltes).pack(pady=20)
    ...
    def halozatgeneralas_lap_inicilaizalasa(self, notebook):
        ...
        ttk.Radiobutton(halozattipus_vaz, text="Kari hálózat (Csak a kari szerzők publikációnak figyelembe vétele, Tanszékek mint csomópontok)", variable=self.halozat_tipusa, value="tanszek_halozat").pack(anchor='w')
        ttk.Radiobutton(halozattipus_vaz, text="Kari hálózat (Csak a kari szerzők publikációnak figyelembe vétele, Szerzők mint csomópontok)", variable=self.halozat_tipusa, value="Kari_hálózat").pack(anchor='w')
    ...
    @staticmethod
    def mtmtfajl_olvasasa(fajl_eleresi_utvonala): #lehet statikus pycharm szerint
    ...
    def publikacio_azonositok_kinyerese(self, publikacio):
    ...
    def publikaciok_feldogozasa(self, publikacio):
        ...
        return {
            ...
            "kulcsszavak": [kw.get("label") for kw in publikacio.get("keywords", [])], #  jelenleg nem használt
...
Kész az adatok betöltése!
    ...
    def publikaciok_szurese(self):
        ...
        if self.megjelenes_eve_alapu_szures.get():
            ...
            szurt = [p for p in szurt if p["Publikálás éve"] and ev_tol <= p["Publikálás éve"] <= ev_ig]
    ...
    def halozat_elkeszitese(self):
        ...
        try:
            ...
            if self.kozos_publikacio_szuro.get():
                ...
                egyuttmukodesek = {k: valtozo for k, valtozo in egyuttmukodesek.items() if valtozo >= minimum_egyuttmukodesek}
    ...
    def tanszeki_halozat_generalas(self, publikaciok):
        ...
        kari_tanszeknev_lower = {inst.lower(): inst for inst in self.Kari_tanszekek_nevei}
    ...
    def kari_halozat_generalas(self, publikaciok):
        ...
        for publikacio in publikaciok:
            for szerzo in publikacio["Szerzőinformációk"]["Minden_szerző"]:
                ...
                if mtid in szerzok:
                    # Szerzőadatok frissítése a txt-kből
    ...
    def cytoscape_csvk_generalasa(self, szerzok, egyuttmukodesek_szama, csomopont_fajl, el_fajl):
